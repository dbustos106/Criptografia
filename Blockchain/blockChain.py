...
class BlockChain:
    ...
    def addTransaction(self, sender, receiver, amount):
        newTransaction = {"sender": sender, "receiver": receiver, "amount": amount}
    ...
    def replaceChain(self):
        ...
        for node in network:
            response = request.get(f'http://{node}/getChain')
...
def mineBlock():
    ...
    blockChain.addTransaction(sender=nodeAddress, receiver="Julian", amount=1)
